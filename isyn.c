/*
 * This is released under the GNU GPL License v3.0 . Rewritten by GigabitWiFi. Used for instant disconnections...oops.
 */
...
srand(time(0));
fprintf(stdout, "You have GigabitWiFi?; Thats gonna be one hell of a problem for you then.\n");
